class WomenCentricInfrastructureJson {
  static Map<String, dynamic> get womenCentricInfrastructureSection => {
    ...
    "fields": [
      ...
      {
        "name": "isWomenCommunityCentre",
        "label": "Is this Women Community Centre",
        "type": "radio",
        "required": true,
        "options": [
          {"label": "Yes", "value": true},
      ...
      },
      {
        ...
        "label": "27. Skill programmes organised",
        "type": "text",
        "required": true,
        "keyboardType": "number",
        "validationMsg":
      ...
      },
      {
        ...
        "label": "28. Health camps organised",
        "type": "text",
        "required": true,
        "keyboardType": "number",
      ...
      },
      {
        ...
        "label": "29. Other Events organised",
        "type": "text",
        "required": true,
        "keyboardType": "number",
