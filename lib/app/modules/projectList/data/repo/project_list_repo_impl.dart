...
class ProjectListRepoImpl extends ProjectListRepo with SnackBarMixin,PopupMixin{
  ...
  @override
  Future<ProjectResponse?> getProjectList({required String status,required String paramName}) async{
    try{
      final resp = await apiService.get(
        NetworkConstants.projectList,
        query: {paramName:status},
      );
  ...
  @override
  Future<ProjectResponse?> getProjectListByGeoTagged({required bool status,required String paramName}) async{
    try{
      final resp = await apiService.get(
        NetworkConstants.projectList,
        query: {paramName:status},
