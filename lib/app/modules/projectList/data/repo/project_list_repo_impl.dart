...
class ProjectListRepoImpl extends ProjectListRepo
  ...
  @override
  Future<ProjectResponse?> getProjectListByGeoTagged({
  ...
  Future<CategoryResponse?> getAllSector() async {
    try {
      final resp = await apiService.get(NetworkConstants.getAllSector);
      if (resp.statusCode == HttpStatus.ok) {
  ...
  @override
  Future<ProjectResponse?> getPendingProjectList() async {
    try {
      final resp = await apiService.get(NetworkConstants.pendingProjectList);
      if (resp.statusCode == HttpStatus.ok) {
        return ProjectResponse.fromJson(resp.data);
      } else {
        ProjectResponse modelData = ProjectResponse();
